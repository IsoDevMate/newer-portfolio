            ...
            <div className="space-y-4">
              ...
              <AccordionSection title="3. Data Protection">
                ...
                >
                  ...
                  onPointerEnterCapture={() => {}}
                  onPointerLeaveCapture={() => {}}
                  >Secure SSL encryption for all data transmission</ListItem>
                                  <ListItem
                                   placeholder=""
                  onPointerEnterCapture={() => {}}
                  onPointerLeaveCapture={() => {}}>Limited access to personal information</ListItem>
                                  <ListItem
                                   placeholder=""
                  onPointerEnterCapture={() => {}}
                  onPointerLeaveCapture={() => {}}>Regular security assessments and updates</ListItem>
                </List>
              </AccordionSection>
              ...
              <AccordionSection title="5. Your Rights">
                              <Typography
                               placeholder=""
                  onPointerEnterCapture={() => {}}
                  onPointerLeaveCapture={() => {}}>You have the right to:</Typography>
                              <List
                                  className="mt-2"
                               placeholder=""
                  onPointerEnterCapture={() => {}}
                  onPointerLeaveCapture={() => {}}>
                                  <ListItem
                                   placeholder=""
                  onPointerEnterCapture={() => {}}
                  onPointerLeaveCapture={() => {}}>Request access to your personal data</ListItem>
                                  <ListItem
                                   placeholder=""
                  onPointerEnterCapture={() => {}}
                  onPointerLeaveCapture={() => {}}>Request correction or deletion of your personal data</ListItem>
                                  <ListItem
                                   placeholder=""
                  onPointerEnterCapture={() => {}}
                  onPointerLeaveCapture={() => {}}>Withdraw your consent at any time</ListItem>
                </List>
              </AccordionSection>
