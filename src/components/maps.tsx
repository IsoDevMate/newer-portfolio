    ...
    <section className="py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
                  <Typography
                      variant="h2"
                      className="mb-4 text-3xl md:text-4xl text-white/90 font-heading"
        ...
        >
                  <Card
                      className="w-full max-w-[800px] mx-auto overflow-hidden bg-gray-800/50 backdrop-blur-sm"
                  placeholder="" onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}>
                      <CardBody
                          className="p-0"
                      placeholder="" onPointerEnterCapture={() => {}} onPointerLeaveCapture={() => {}}>
              <div className="relative w-full aspect-video">
                ...
                <iframe
                  className="gmap_iframe w-full h-full rounded-lg"
                  frameBorder="0"
                  scrolling="no"
                  marginHeight={0}
                  marginWidth={0}
