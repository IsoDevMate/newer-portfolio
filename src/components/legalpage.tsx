...
// Types for our legal content sections
...
const LegalPage: React.FC<{
  ...
  return (
    <motion.div
      className="min-h-screen py-12 px-4 md:px-8 bg-gray-900"
      variants={pageVariants}
      initial="initial"
      animate="animate"
      exit="exit"
...
export const TermsOfService: React.FC = () => {
  ...
  return (
    <LegalPage
      ...
      introduction="Welcome! These Terms of Service govern your use of my portfolio website. By accessing or using this site, you agree to be bound by these terms."
...
export const PrivacyPolicy: React.FC = () => {
  ...
  return (
    <LegalPage
      ...
      introduction="This Privacy Policy explains how we collect, use, and protect your personal information when you use our website."
