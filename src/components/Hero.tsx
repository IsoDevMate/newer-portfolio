...
export const Hero = () => {
    return (
      ...
      >
        <motion.div 
          className="w-32 h-32 mx-auto mb-8 rounded-full overflow-hidden bg-gray-800"
        ...
        <motion.h1 
          className="text-5xl md:text-6xl font-heading mb-4 text-white/90"
        ...
        >
          ...
          <motion.button 
            className="bg-gray-800/80 text-white/90 px-8 py-3 rounded-md text-lg hover:bg-gray-700/80 transition-colors duration-300"
